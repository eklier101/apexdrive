Write-Host "=== Building Vehicle Tracker Web Assets ===" -ForegroundColor Cyan
...
if (Test-Path ".\gradlew.bat") {
    ...
    Copy-Item $apkSource "$destDir/vehicle-tracker-latest.apk" -Force
    Write-Host "=== APK Successfully Built and Saved to server/data/apks/vehicle-tracker-latest.apk ===" -ForegroundColor Green
} else {
