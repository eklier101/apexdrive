        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-sm">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Download the mobile app for your self-hosted ApexDrive server
                </p>
              </div>
            </div>
          ...
          {latestRelease?.version && (
            <p className="text-[11px] text-slate-500 mt-3">
              Server package: v{latestRelease.version}
              {latestRelease.release_notes ? ` — ${latestRelease.release_notes}` : ''}
            </p>
          )}
        </div>
      )}
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Check, download, and install updates from your server
                </p>
              </div>
            </div>
