...
import { BellRing, Plus, Trash2, Edit, CheckCircle2, AlertTriangle, Clock, RefreshCw } from 'lucide-react';
              ...
              >
                <div>
                  ...
                  <div className="text-xs text-slate-400 flex items-center gap-2">
                    ...
                    <span>
                      Interval: Every {rem.interval_miles ? `${rem.interval_miles.toLocaleString()} ${odoUnit}` : ''}
                      {rem.interval_miles && rem.interval_months ? ' or ' : ''}
                      {rem.interval_months ? `${rem.interval_months} months` : ''}
                    </span>
                  </div>
