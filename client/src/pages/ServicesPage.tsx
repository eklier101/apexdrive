        ...
        <div className="flex items-center gap-2">
          {onNavigate && (
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-2.5 bg-slate-800 hover:bg-slate-700 text-amber-300 border border-amber-500/30 font-bold text-sm rounded-xl transition active:scale-95"
            >
