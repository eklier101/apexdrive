...
export const Navbar: React.FC<NavbarProps> = ({ activeTab, onSelectTab }) => {
  ...
  const moreItems = useMemo(() => {
    if (!isAdmin) return baseMoreItems;
    return [...baseMoreItems, { id: 'adminUsers' as NavTab, label: 'Users', icon: Shield }];
  }, [isAdmin]);

  const allItems = useMemo(() => [...primaryItems, ...moreItems], [moreItems]);
