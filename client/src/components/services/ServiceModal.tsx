...
export const ServiceModal: React.FC<ServiceModalProps> = ({
  ...
  useEffect(() => {
    ...
    const sessionKey = serviceToEdit?.id || (defaults ? `defaults:${defaults.service_type}:${defaults.title}` : 'new');
  ...
  }, [isOpen, serviceToEdit?.id, defaults?.service_type, defaults?.title, defaults?.odometer]);
