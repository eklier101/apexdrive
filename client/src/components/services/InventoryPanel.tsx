...
export const InventoryPanel: React.FC<InventoryPanelProps> = ({
  ...
  return (
    <div className="bg-slate-900/80 border border-slate-800 rounded-3xl overflow-hidden">
      ...
      {expanded && (
        <div className="px-5 pb-5 border-t border-slate-800/80 pt-4 space-y-4">
          <div className="flex items-center justify-between gap-3">
            ...
            {!showForm && (
              <button
                ...
                className="flex-shrink-0 flex items-center gap-1.5 px-3 py-2 bg-amber-600/20 hover:bg-amber-600/30 text-amber-300 text-xs font-bold rounded-xl border border-amber-500/30 transition"
              >
