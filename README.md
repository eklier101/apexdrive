...
- **Android APK** — [GitHub Releases](https://github.com/eklier101/apexdrive/releases) (sideload / self-hosted updates)
- **Google Play** — package `com.apexdrive.app` (when the listing is published; Play builds update through the store)
...
**Package name:** `com.apexdrive.app`
...
If you previously installed an older package ID (`com.vehicletracker.app`), uninstall it once before installing the current APK or Play build.
