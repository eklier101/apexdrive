...
1. Open **Settings → Server Connection URL**
2. Enter your server (for example `http://192.168.1.50:8090` or `https://your-domain.com`)
3. **Save & Connect**, then register or log in

There is no default server URL in the app.

If you already run ApexDrive, you can also fetch the APK from your own server after you have placed one there: `http://<your-server>:8090/api/app/download-latest`.
...
Output: `server/data/apks/vehicle-tracker-latest.apk`
