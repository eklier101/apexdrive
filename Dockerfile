...
RUN apk add --no-cache ca-certificates wget openjdk17-jre-headless \
  && mkdir -p /app/data/uploads /app/data/apks /app/public /app/apk-signing /app/bundled-apk
...
ENV APK_BUNDLED_DIR=/app/bundled-apk
ENV APK_GITHUB_REPO=eklier101/apexdrive
ENV APK_AUTO_FETCH=1

COPY --from=go-builder /out/apexdrive /app/apexdrive
COPY --from=client-builder /app/client/dist /app/public
COPY bundled-apk/ /app/bundled-apk/
